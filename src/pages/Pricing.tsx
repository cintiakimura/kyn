        ...
        <div className="grid md:grid-cols-2 gap-8 text-left">
          ...
          <div className="p-8 bg-[#111] border border-[#222] rounded-2xl">
            ...
            <ul className="space-y-4 mb-8 text-gray-300">
              ...
              <li className="flex items-center gap-2">✓ Basic AI generation</li>
          ...
          <div className="p-8 bg-gradient-to-b from-[#1a1a2e] to-[#111] border border-blue-500/30 rounded-2xl relative shadow-2xl shadow-blue-900/20">
            ...
            <p className="text-blue-200/70 mb-6">For serious developers.</p>
            <div className="text-4xl font-bold text-white mb-8">$9<span className="text-lg text-gray-500 font-normal">/mo</span></div>
            <ul className="space-y-4 mb-8 text-gray-300">
              <li className="flex items-center gap-2">✓ Unlimited projects</li>
              <li className="flex items-center gap-2">✓ Priority debug (VETR)</li>
              <li className="flex items-center gap-2">✓ Auto-deploy hooks</li>
            </ul>
